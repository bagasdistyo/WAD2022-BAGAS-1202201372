  ...
  ?>
            ...
            <div class="collapse navbar-collapse">
                <div class="navbar-nav" style="padding-left: 100px;">
                    <a style="color: white;" class="nav-link active" aria-current="page"
                        href="HomeAwal.php?id=<?php echo $data1['id']; ?>">Home</a>
                    <a class="nav-link" style="padding-left: 35px; padding-right:900px;color: white;"
                        href="ListCar-Bagas.php?id=<?php echo $data1['id']; ?>">MyCar</a>
                </div>
                <a class="btn btn-light" style="font-color:blue;" role="button"
                    href="Add-Bagas.php?id=<?php echo $data1['id']; ?>">Add Car</a>
                <div class="dropdown" style="padding-left: 30px;">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="Profil-Bagas.php?id=<?php echo $data1['id']; ?>">Profile</a>
                        </li>
    ...
    <div class="container" style="padding-top: 100px;">
        <div class="row">
            <div class="col">
                <div>
                    <h1 style="padding-top: 25px; font-size:50px;">Selamat Datang Di Showroom <?= $data1['nama'] ?></h1>
                </div>
