...
<html lang="en">
  ...
  <?php
    ...
    $ambil = mysqli_query($kon, "SELECT * FROM `modul3` where id_mobil=$id_mobil");
  ...
  <div class="container" style="padding-top: 20px;">
    <div class="row">
        ...
        <div class="col">
        <form action="../config/edit.php?id_mobil=<?=$isi['id_mobil']?>" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="id_mobil" value="<?= $isi["id_mobil"];?>">
            <div class="mb-3">
                <label for="nama_mobil" class="form-label">Nama Mobil</label>
                <input class="form-control" name="nama_mobil" id="nama_mobil" type="text" value="<?=$isi['nama_mobil']?>">
            </div>
            <div class="mb-3">
                <label for="pemilik_mobil" class="form-label">Nama Pemilik</label>
                <input class="form-control" name="pemilik_mobil" id="pemilik_mobil" type="text" value="<?=$isi['pemilik_mobil']?>">
            </div>
            <div class="mb-3">
                <label for="merk_mobil" class="form-label">Merk</label>
                <input class="form-control" name="merk_mobil" id="merk_mobil" type="text" value="<?=$isi['merk_mobil']?>">
            </div>
            <div class="mb-3">
                <label for="tanggal_beli" class="form-label">Tanggal Beli</label>
                <input class="form-control" name="tanggal_beli" id="tanggal_beli" type="date" value="<?=$isi['tanggal_beli']?>">
            </div>
            <div class="mb-3">
                <label for="deskripsi" class="form-label">Deskripsi</label>
                <textarea class="form-control" name="deskripsi" id="deskripsi" rows="5" value="<?=$isi['deskripsi']?>"></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="status_pembayaran" id="status_pembayaran" value="<?=$isi['status_pembayaran']?>">
            ...
            <div style="padding-top: 30px;">
                <button type="submit" class="btn btn-primary" role="button" name="edit" id="edit">Selesai</button>
            </div>
