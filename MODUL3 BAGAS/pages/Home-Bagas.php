  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse">
      <div class="navbar-nav" style="padding-left: 100px;">
        ...
        <?php
          if ($jumlah == 0){
              echo '<a class="nav-link" style="padding-left: 35px; color: white;"href="pages/Add-Bagas.php">MyCar</a>';
            }
          else{
              echo '<a class="nav-link" style="padding-left: 35px; color: white;" href="pages/ListCar-Bagas.php">MyCar</a>';
            }
        ?>
      </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <div style="padding-top: 30px;">
              <?php
                  if ($jumlah == 0){
                      echo '<a class="btn btn-primary" href="pages/Add-Bagas.php" role="button">MyCar</a>';
                    }
                  else{
                      echo '<a class="btn btn-primary" href="pages/ListCar-Bagas.php" role="button">MyCar</a>';
                    }
              ?>
            </div>
